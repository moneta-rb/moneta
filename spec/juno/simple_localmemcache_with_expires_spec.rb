...
describe_juno "simple_localmemcache_with_expires" do
  def new_store
    Juno.new(:LocalMemCache, :file => File.join(make_tempdir, "simple_localmemcache_with_expires"), :expires => true, :logger => {:out => File.open(File.join(make_tempdir, 'simple_localmemcache_with_expires.log'), 'a')})
  end
