...
describe_juno "simple_hashfile_with_expires" do
  def new_store
    Juno.new(:HashFile, :dir => File.join(make_tempdir, "simple_hashfile_with_expires"), :expires => true, :logger => {:out => File.open(File.join(make_tempdir, 'simple_hashfile_with_expires.log'), 'a')})
  end
