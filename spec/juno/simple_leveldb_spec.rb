...
describe_juno "simple_leveldb" do
  def new_store
    Juno.new(:LevelDB, :dir => File.join(make_tempdir, "simple_leveldb"), :logger => {:out => File.open(File.join(make_tempdir, 'simple_leveldb.log'), 'a')})
  end
