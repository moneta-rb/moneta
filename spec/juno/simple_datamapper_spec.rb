...
describe_juno "simple_datamapper" do
  require 'dm-core'
  DataMapper.setup(:default, :adapter => :in_memory)
  def new_store
    Juno.new(:DataMapper, :setup => "sqlite3://#{make_tempdir}/simple_datamapper", :logger => {:out => File.open(File.join(make_tempdir, 'simple_datamapper.log'), 'a')})
  end
