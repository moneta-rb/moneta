...
describe_juno "simple_pstore_with_expires" do
  def new_store
    Juno.new(:PStore, :file => File.join(make_tempdir, "simple_pstore_with_expires"), :expires => true, :logger => {:out => File.open(File.join(make_tempdir, 'simple_pstore_with_expires.log'), 'a')})
  end
