...
describe_juno "simple_file_with_expires" do
  def new_store
    Juno.new(:File, :dir => File.join(make_tempdir, "simple_file_with_expires"), :expires => true, :logger => {:out => File.open(File.join(make_tempdir, 'simple_file_with_expires.log'), 'a')})
  end
