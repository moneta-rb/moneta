...
describe_juno "simple_datamapper_with_repository" do
  ...
  def new_store
    Juno.new(:DataMapper, :repository => :repo, :setup => "sqlite3://#{make_tempdir}/simple_datamapper_with_repository", :logger => {:out => File.open(File.join(make_tempdir, 'simple_datamapper_with_repository.log'), 'a')})
  end
