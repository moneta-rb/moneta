...
describe_juno "simple_hbase_with_expires" do
  def new_store
    Juno.new(:HBase, :table => "simple_hbase", :expires => true, :logger => {:out => File.open(File.join(make_tempdir, 'simple_hbase_with_expires.log'), 'a')})
  end
