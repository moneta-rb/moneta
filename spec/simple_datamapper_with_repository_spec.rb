...
begin
  ...
  describe "simple_datamapper_with_repository" do
    let(:store) do
      Juno.new(:DataMapper, :repository => :repo, :setup => "sqlite3://#{make_tempdir}/simple_datamapper_with_repository")
    end
  ...
  puts "\e[31mTest simple_datamapper_with_repository not executed: #{ex.message}\e[0m"
rescue Exception => ex
  puts "\e[31mTest simple_datamapper_with_repository not executed: #{ex.message}\e[0m"
