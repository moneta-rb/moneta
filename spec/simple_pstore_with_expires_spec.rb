...
begin
  ...
  describe "simple_pstore_with_expires" do
    let(:store) do
      Juno.new(:PStore, :file => File.join(make_tempdir, "simple_pstore_with_expires"), :expires => true)
    end
  ...
  puts "\e[31mTest simple_pstore_with_expires not executed: #{ex.message}\e[0m"
rescue Exception => ex
  puts "\e[31mTest simple_pstore_with_expires not executed: #{ex.message}\e[0m"
