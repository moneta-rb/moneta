...
describe_juno "simple_sdbm_with_expires" do
  def new_store
    Juno.new(:SDBM, :file => File.join(make_tempdir, "simple_sdbm_with_expires"), :expires => true, :logger => true, :logout => File.open(File.join(make_tempdir, 'simple_sdbm_with_expires.log'), 'a'))
  end
