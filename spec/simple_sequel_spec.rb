...
begin
  ...
  describe "simple_sequel" do
    let(:store) do
      Juno.new(:Sequel, :db => (defined?(JRUBY_VERSION) ? "jdbc:sqlite:" : "sqlite:") + File.join(make_tempdir, "simple_sequel"))
    end
  ...
  puts "\e[31mTest simple_sequel not executed: #{ex.message}\e[0m"
rescue Exception => ex
  puts "\e[31mTest simple_sequel not executed: #{ex.message}\e[0m"
