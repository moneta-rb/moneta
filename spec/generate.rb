...
SIMPLE_SPECS_WITHOUT_MARSHAL = [:null, :store, :returndifferent, :marshallable_key, :marshallable_value]
SIMPLE_SPECS = SIMPLE_SPECS_WITHOUT_MARSHAL + [:bypass_transformer]
EXPIRES_SPECS = SIMPLE_SPECS_WITHOUT_MARSHAL + [:expires_stringkey_stringvalue, :bypass_transformer_with_expires]
...
SPECS['bypass_transformer_with_expires']  = %{it 'allows to bypass transformer with :raw' do
  store['key'] = 'value'
  store.load('key', :raw => true).should == Marshal.dump(['value'])
