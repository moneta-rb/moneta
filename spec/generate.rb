...
EXPIRES_SPECS = SIMPLE_SPECS + [:expires_stringkey_stringvalue, :bypass_transformer_with_expires]
EXPIRES_SPECS.delete(:bypass_transformer)
...
it 'should share values' do
  ...
  adapter :Memory
    ...
    :value => %w(String),
    :specs => TRANSFORMER_SPECS,
    :load_value => '::LZO.uncompress(value)'
  },
  'transformer_lzma' => {
    :build => %{Moneta.build do
  ...
  adapter :Memory
    ...
    :value => %w(String),
    :specs => TRANSFORMER_SPECS,
    :load_value => '::LZMA.uncompress(value)'
  },
  'transformer_snappy' => {
    :build => %{Moneta.build do
  ...
  adapter :Memory
    ...
    :value => %w(String),
    :specs => TRANSFORMER_SPECS,
    :load_value => '::QuickLZ.uncompress(value)'
  },
  'transformer_json' => {
    :build => %{Moneta.build do
 ...
 adapter :Memory
    ...
    :value => %w(Hash String),
    :specs => TRANSFORMER_SPECS,
    :load_value => '::TNetstring.parse(value)'
  },
  'transformer_msgpack' => {
    :build => %{Moneta.build do
