...
begin
  ...
  describe "simple_datamapper_with_expires" do
    let(:store) do
      Juno.new(:DataMapper, :setup => "sqlite3://#{make_tempdir}/simple_datamapper_with_expires", :expires => true)
    end
  ...
  puts "\e[31mTest simple_datamapper_with_expires not executed: #{ex.message}\e[0m"
rescue Exception => ex
  puts "\e[31mTest simple_datamapper_with_expires not executed: #{ex.message}\e[0m"
