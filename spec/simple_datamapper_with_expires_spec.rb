...
begin
  ...
  Juno.new(:DataMapper, :setup => "sqlite3://#{make_tempdir}/simple_datamapper-default.sqlite3", :expires => true).close

  describe "simple_datamapper_with_expires" do
    before do
      @store = Juno.new(:DataMapper, :setup => "sqlite3://#{make_tempdir}/simple_datamapper-default.sqlite3", :expires => true)
      @store.clear
    end
