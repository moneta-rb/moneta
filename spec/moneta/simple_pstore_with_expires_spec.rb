...
describe_moneta "simple_pstore_with_expires" do
  ...
  def new_store
    Moneta.new(:PStore, :file => File.join(make_tempdir, "simple_pstore_with_expires"), :expires => true, :logger => {:file => File.join(make_tempdir, 'simple_pstore_with_expires.log')})
  end
