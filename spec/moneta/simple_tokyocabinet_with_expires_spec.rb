...
describe_moneta "simple_tokyocabinet_with_expires" do
  ...
  def new_store
    Moneta.new(:TokyoCabinet, :file => File.join(make_tempdir, "simple_tokyocabinet_with_expires"), :expires => true, :logger => {:file => File.join(make_tempdir, 'simple_tokyocabinet_with_expires.log')})
  end
