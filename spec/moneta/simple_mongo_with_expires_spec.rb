...
describe_moneta "simple_mongo_with_expires" do
  def new_store
    Moneta.new(:Mongo, :db => 'simple_mongo_with_expires', :expires => true, :logger => {:out => File.open(File.join(make_tempdir, 'simple_mongo_with_expires.log'), 'a')})
  end
