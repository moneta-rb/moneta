...
describe_moneta "simple_memory_with_json_md5_key_serializer" do
  def new_store
    Moneta.new(:Memory, :key_serializer => [:json, :md5], :logger => {:out => File.open(File.join(make_tempdir, 'simple_memory_with_json_md5_key_serializer.log'), 'a')})
  end
