...
describe_moneta "simple_lmdb_with_expires" do
  def features
    [:create, :expires, :increment]
  end

  def new_store
    Moneta.new(:LMDB, :dir => File.join(make_tempdir, "simple_lmdb_with_expires"), :expires => true, :logger => {:file => File.join(make_tempdir, 'simple_lmdb_with_expires.log')})
  end
