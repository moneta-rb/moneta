...
describe_moneta "transformer_key_marshal" do
  def features
    [:create, :increment]
  end
  ...
  it_should_behave_like 'returnsame_objectkey_numbervalue'
  ...
  it_should_behave_like 'returnsame_stringkey_numbervalue'
  ...
  it_should_behave_like 'returnsame_hashkey_numbervalue'
  ...
  it_should_behave_like 'returnsame_booleankey_numbervalue'
  ...
  it_should_behave_like 'returnsame_nilkey_numbervalue'
  ...
  it_should_behave_like 'returnsame_integerkey_numbervalue'
  ...
  it_should_behave_like 'returnsame_numberkey_numbervalue'
