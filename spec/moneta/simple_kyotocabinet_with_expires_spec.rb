...
describe_moneta "simple_kyotocabinet_with_expires" do
  def features
    [:create, :expires, :increment]
  end

  def new_store
    Moneta.new(:KyotoCabinet, :file => File.join(make_tempdir, "simple_kyotocabinet_with_expires.kch"), :expires => true, :logger => {:file => File.join(make_tempdir, 'simple_kyotocabinet_with_expires.log')})
  end
  ...
  it_should_behave_like 'returndifferent_objectkey_numbervalue'
  it_should_behave_like 'returndifferent_stringkey_objectvalue'
  it_should_behave_like 'returndifferent_stringkey_stringvalue'
  it_should_behave_like 'returndifferent_stringkey_hashvalue'
  it_should_behave_like 'returndifferent_stringkey_numbervalue'
  it_should_behave_like 'returndifferent_hashkey_objectvalue'
  it_should_behave_like 'returndifferent_hashkey_stringvalue'
  it_should_behave_like 'returndifferent_hashkey_hashvalue'
  it_should_behave_like 'returndifferent_hashkey_numbervalue'
  ...
  it_should_behave_like 'returndifferent_booleankey_numbervalue'
  ...
  it_should_behave_like 'returndifferent_nilkey_numbervalue'
  ...
  it_should_behave_like 'returndifferent_integerkey_numbervalue'
  ...
  it_should_behave_like 'returndifferent_numberkey_numbervalue'
