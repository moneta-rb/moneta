...
describe_moneta "simple_memory_with_quicklz_compress" do
  def new_store
    Moneta.new(:Memory, :compress => :quicklz, :logger => {:out => File.open(File.join(make_tempdir, 'simple_memory_with_quicklz_compress.log'), 'a')})
  end
