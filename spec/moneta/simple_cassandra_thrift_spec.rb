...
describe_moneta "simple_cassandra_thrift" do
  def features
    [:expires]
  end

  def new_store
    Moneta.new(:CassandraThrift, :keyspace => "simple_cassandra_thrift", :logger => {:file => File.join(make_tempdir, 'simple_cassandra_thrift.log')})
  end
