...
describe_juno "simple_lruhash_with_expires" do
  def new_store
    Juno.new(:LRUHash, :expires => true, :logger => true, :logout => File.open(File.join(make_tempdir, 'simple_lruhash_with_expires.log'), 'a'))
  end
