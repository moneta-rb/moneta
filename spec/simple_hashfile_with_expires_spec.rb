...
begin
  ...
  describe "simple_hashfile_with_expires" do
    let(:store) do
      Juno.new(:HashFile, :dir => File.join(make_tempdir, "simple_hashfile_with_expires"), :expires => true)
    end
  ...
  puts "\e[31mTest simple_hashfile_with_expires not executed: #{ex.message}\e[0m"
rescue Exception => ex
  puts "\e[31mTest simple_hashfile_with_expires not executed: #{ex.message}\e[0m"
